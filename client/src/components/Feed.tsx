    ...
    <div className="w-full max-w-2xl mx-auto">
      {loading ? (
        ...
        <ul className="space-y-6">
          {posts.map(post => (
            <li key={post.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-3">
                  <Link href={`/profile/${post.author.id}`} className="font-medium text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400">
                    {post.author.name}
                  </Link>
